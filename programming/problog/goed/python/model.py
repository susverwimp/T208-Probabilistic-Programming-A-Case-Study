...
lf = engine.ground_all(db, queries=[query_term], evidence=[(evidence_block00, True),(evidence_block10, True),(evidence_block20, True),(evidence_block01, True),(evidence_block11, True),(evidence_block21, True),(evidence_block02, True),(evidence_block12, True),(evidence_block22, True)])
