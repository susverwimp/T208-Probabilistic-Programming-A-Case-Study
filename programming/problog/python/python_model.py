...
def problogChain(engine, db, permutation):
    ...
    evidence_block01 = Term('block', Term('red'), Constant(0), Constant(1))
    evidence_block11 = Term('block', Term('blue'), Constant(1), Constant(1))
    evidence_block21 = Term('block', Term('red'), Constant(2), Constant(1))
    evidence_block02 = Term('block', Term('blue'), Constant(0), Constant(2))
    evidence_block12 = Term('block', Term('red'), Constant(1), Constant(2))
    evidence_block22 = Term('block', Term('red'), Constant(2), Constant(2))
